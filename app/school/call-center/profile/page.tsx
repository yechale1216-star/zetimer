...
import { Mail, Phone, Shield, Headphones } from 'lucide-react'

export default function CallCenterOfficerProfile() {
  const { user } = useAuth()
  return (
      ...
      <div className="rounded-2xl border border-border/60 bg-card p-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-sm font-semibold text-teal-600">School Call Center Officer</span>
            </div>
          </div>
        </div>
        <div className="space-y-3 pt-4 border-t border-border/40">
          {[
            ...
            { icon: Shield, label: 'Role', value: 'Call Center Officer' },
            { icon: Headphones, label: 'School ID', value: user?.schoolId || 'N/A' },
          ].map(f => (
