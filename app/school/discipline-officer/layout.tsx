...
import {
  LayoutDashboard, ShieldAlert, FilePlus, Users, BarChart2,
  User, LogOut, X, ChevronRight, Scale
} from 'lucide-react'
...
const navItems = [
  { href: '/school/discipline-officer', icon: LayoutDashboard, label: 'Dashboard', exact: true },
  { href: '/school/discipline-officer/new-incident', icon: FilePlus, label: 'New Incident' },
  { href: '/school/discipline-officer/cases', icon: ShieldAlert, label: 'Active Cases' },
  { href: '/school/discipline-officer/students', icon: Users, label: 'Student History' },
  { href: '/school/discipline-officer/reports', icon: BarChart2, label: 'Reports' },
        ...
        <div className="flex items-center gap-3">
          ...
          {(!isCollapsed || mobile) && (
            <div className="min-w-0">
              <p className="font-bold text-sm truncate">Discipline</p>
