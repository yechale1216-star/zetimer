    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-blue-500/20">
      ...
      <main className="max-w-4xl mx-auto px-8 py-20 relative z-10">
        ...
        <div className="space-y-6 mb-16">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-slate-900 dark:text-white uppercase leading-[1.2]">Terms of <br /><span className="text-indigo-600">Service.</span></h1>
