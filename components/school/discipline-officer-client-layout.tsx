...
import {
  LayoutDashboard, ShieldAlert, FilePlus, Users, BarChart2, ClipboardList, Layers,
...
const navItems = [
  { href: '/school/discipline-officer', icon: BarChart2, label: 'Dashboard & Analytics', exact: true },
  { href: '/school/discipline-officer/cases', icon: ClipboardList, label: 'Incidents Directory' },
