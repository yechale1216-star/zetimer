-- Complete database reset - drops all tables and recreates from scratch
-- This script will completely clean the database and recreate all schema
...
-- Add school_id foreign key after schools table exists
