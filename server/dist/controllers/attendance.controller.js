...
const getAttendance = async (req, res, next) => {
    try {
        const schoolId = req.headers['x-school-id'];
        const { studentId, date, session, grade, section } = req.query;
        const attendance = await attendanceService.getAttendance({ studentId, date, session, grade, section, schoolId });
